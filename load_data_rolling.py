...
def main():
    ...
    rolling_mean_db = RollingMeanDatabase(db_name, table_rolling_price_history )

    # Seleccionar los datos de la media móvil de la base de datos y obtener la fecha más reciente
    rolling_history_data = rolling_mean_db.select_data(table_rolling_price_history)
    ...
    if len(filtered_df_to_load):
        ...
        rolling_mean_db.insert_data(filtered_df_to_load, table_rolling_price_history)
        rolling_data_db = rolling_mean_db.select_data(table_rolling_price_history)
